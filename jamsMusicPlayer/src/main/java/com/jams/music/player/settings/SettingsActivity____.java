...
import com.jams.music.player.blacklist.BlacklistManagerActivity;
	...
	protected void onCreate(Bundle savedInstanceState) {
    	...
    	upgradePreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
			...
			public boolean onPreferenceClick(Preference preference) {
				//initInAppBilling();
				Intent intent = new Intent(mContext, com.jams.music.player.launcher.LauncherActivity.class);
